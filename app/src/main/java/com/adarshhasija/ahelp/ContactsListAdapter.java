...
public class ContactsListAdapter extends ArrayAdapter<Contact> implements Filterable {
    ...
    public ContactsListAdapter(Context context, int resource, List<Contact> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView fullNameView = (TextView) rowView.findViewById(R.id.full_name);
        TextView phoneNumberView = (TextView) rowView.findViewById(R.id.phone_number);

        Contact contact = values.get(position);

        fullNameView.setText(contact.getName());
        phoneNumberView.setText(contact.getNumber());
        rowView.setTag(contact);
        rowView.setContentDescription("Name is: "+contact.getName() + ". Number is: "+contact.getNumber());
        return rowView;
    }
