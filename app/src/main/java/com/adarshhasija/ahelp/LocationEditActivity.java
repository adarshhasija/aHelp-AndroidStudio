...
public class LocationEditActivity extends Activity {
	...
	private boolean validate() {
		...
		if(title.isEmpty()) {
			Toast.makeText(getBaseContext(), "You have not entered a title for this location", Toast.LENGTH_SHORT).show();
			return false;
		}
	...
	private void savePressed() {
		if(validate()) {
			...
			parseObject.pinInBackground("Location", saveCallback);
		}
	}
        ...
        builder.setMessage("Are you sure?")
               .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
            		   ...
            		   parseObject.unpinInBackground("Location", deleteCallback);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.location_edit_activity, menu);
